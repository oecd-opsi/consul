shared_examples "oecd_representative_milestoneable" do |factory_name, path_name|
  it_behaves_like "oecd_representative_progressable", factory_name, path_name

  describe "OECD Representative milestones" do
