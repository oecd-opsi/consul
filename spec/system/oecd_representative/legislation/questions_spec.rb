...
describe "OECD Representative legislation questions" do
  ...
  context "Feature flag" do
    ...
    scenario "Disabled with a feature flag" do
      expect { visit oecd_representative_legislation_process_questions_path(process) }
  ...
  context "Delete" do
    scenario "Legislation question", :js do
      ...
      visit edit_oecd_representative_legislation_process_question_path(process, question)
